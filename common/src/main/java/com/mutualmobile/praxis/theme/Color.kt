package com.mutualmobile.praxis.theme

import androidx.compose.ui.graphics.Color

val PraxisCloneColor = Color(0xff411540)
...
val PraxisLogoYellow = Color(0xffECB22E)
val LineColorLight = Color.Black.copy(alpha = 0.4f)
val LineColorDark = Color.LightGray.copy(alpha = 0.1f)
