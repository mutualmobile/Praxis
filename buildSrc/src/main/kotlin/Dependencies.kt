...
object BuildPlugins {
    ...
    const val KOTLIN_GRADLE_PLUGIN =
        "org.jetbrains.kotlin:kotlin-gradle-plugin:${Lib.Kotlin.KOTLIN_VERSION}"
...
object Lib {
    ...
    object Google {
        private const val MATERIAL_DESIGN_VERSION = "1.6.1"
    ...
    object Androidx {
        ...
        private const val SPLASH_SCREEN_API =
        ...
        object Compose {
            private const val NAVIGATION_COMPOSE_VERSION = "2.5.2"
            private const val CONSTRAINT_LAYOUT_COMPOSE_VERSION = "1.0.1"

            private const val ACTIVITY_COMPOSE =
                "androidx.activity:activity-compose:$COMPOSE_VERSION"
            ...
            private const val COMPOSE_TOOLING =
                "androidx.compose.ui:ui-tooling-preview:$COMPOSE_VERSION"
            private const val COMPOSE_DEBUG_TOOLING =
    ...
    object Accompanist {
        private const val ACCOMPANIST_VERSION = "0.26.4-beta"

        private const val insets = "com.google.accompanist:accompanist-insets:$ACCOMPANIST_VERSION"
        private const val pager = "com.google.accompanist:accompanist-pager:$ACCOMPANIST_VERSION"
        private const val pagerIndicators =
    ...
    object Di {
        ...
        const val hiltAndroidCompiler =
            "com.google.dagger:hilt-android-compiler:${BuildPlugins.DAGGER_VERSION}"
    ...
    object Networking {
        ...
        private const val KTOR = "io.ktor:ktor-client-android:$KTOR_VERSION"
        private const val KTOR_LOGGING = "io.ktor:ktor-client-logging-jvm:$KTOR_VERSION"
...
object UnitTesting {
    ...
    private const val coroutineTest =
        "org.jetbrains.kotlinx:kotlinx-coroutines-test:${Lib.Kotlin.COROUTINES_VERSION}"
    private const val turbine = "app.cash.turbine:turbine:$TURBINE_VERSION"
